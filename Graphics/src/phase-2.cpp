...
int main()
{
    ...
    for(int i=0;i<500;i++)
     {
        setcolor(RED+i);
        readimagefile("frontbg1.jpg",1000+i,0+i,1366+i,300+i);
        settextstyle(BOLD_FONT,HORIZ_DIR,8);
        outtextxy(380+i,50+i,"4 QUEEN PUZZLE");
